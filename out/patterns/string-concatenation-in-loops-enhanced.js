...
exports.enhancedStringConcatenationInLoopsRule = exports.EnhancedStringConcatenationInLoopsMatcher = void 0;
const types_1 = require("../types");
/**
 * Enhanced Matcher for detecting string concatenation inside loops
 * with personalized fix generation
 */
class EnhancedStringConcatenationInLoopsMatcher {
    match(node, context) {
     ...
     */
    generatePersonalizedFix(node, context) {
        try {
     ...
     */
    analyzeCodeContext(node, context) {
     ...
     */
    collectAllConcatenations(lines, _startLine, loopInfo) {
        if (!loopInfo)
            return [];
     ...
     */
    buildPersonalizedSolution(analysis) {
...
const ${variableName} = ${array}.map(${iterator} => 
     ...
     */
    buildSimpleSolution(variableName, _concatenations) {
        const arrayName = `${variableName}Parts`;
...
const ${variableName} = ${arrayName}.join('');`;
     ...
     */
    convertToTemplateLiteral(expression, iteratorVar) {
     ...
     */
    calculateReplacementRange(_analysis) {
...
exports.EnhancedStringConcatenationInLoopsMatcher = EnhancedStringConcatenationInLoopsMatcher;
/**
 * Enhanced tooltip template with dynamic content
 */
const enhancedStringConcatenationInLoopsTemplate = {
 ...
 */
exports.enhancedStringConcatenationInLoopsRule = {
...
//# sourceMappingURL=string-concatenation-in-loops-enhanced.js.map