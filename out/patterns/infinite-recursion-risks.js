...
exports.infiniteRecursionRisksTemplate = exports.infiniteRecursionRisksRule = exports.InfiniteRecursionRisksMatcher = void 0;
 ...
 */
class InfiniteRecursionRisksMatcher {
    match(node, context) {
    ...
    hasRecursionRisk(node, _context) {
        const functionName = this.getFunctionName(node);
        if (!functionName)
            return false;
    ...
    hasRecursiveCall(node, functionName) {
        if (!functionName)
            return false;
        // Get function body
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    containsRecursiveCall(node, functionName) {
    ...
    containsAnonymousRecursion(node) {
        if (!node || typeof node !== 'object')
            return false;
    ...
    hasNonRecursiveReturn(node, functionName) {
        if (!node || typeof node !== 'object')
            return false;
    ...
    containsFunctionCall(node, functionName) {
        if (!node || typeof node !== 'object')
            return false;
        if (node.type === 'CallExpression') {
...
exports.InfiniteRecursionRisksMatcher = InfiniteRecursionRisksMatcher;
/**
 * Tooltip template for infinite recursion risks
 */
const infiniteRecursionRisksTemplate = {
...
exports.infiniteRecursionRisksTemplate = infiniteRecursionRisksTemplate;
/**
 * Infinite recursion risks pattern rule
 */
exports.infiniteRecursionRisksRule = {
...
//# sourceMappingURL=infinite-recursion-risks.js.map